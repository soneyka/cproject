        ...
        return (
            <div>
                <div className="row mt-5">
                    <button onClick={this.routeBack} className="btn btn-outline-success">Назад</button>
                </div>
                ...
                <ProfileRow text={`${product} пользователь`} />
                <ProfileRow text={`${total} подписчиков`} />
                <ProfileRow text="Публичных плейлистов" />
